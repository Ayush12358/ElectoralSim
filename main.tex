...
\textit{In Plain English: When voters care more about personal benefits than ideology, governments become very stable—but less accountable.}
...
\textit{In Plain English: Surprisingly, one-sided dominance creates more stable governments than evenly-split competition.}
...
\textbf{Note}: The extended model (Laws IV--V) addresses clientelism and asymmetric polarization, which were limitations in earlier versions.
