...
def main():
    ...
    print(results_df.select([
        'config_idx', 'run_idx', 'n_voters', 'temperature', 
        'economic_growth', 'electoral_system', 'turnout', 'gallagher'
    ]).head())
    ...
    print(summary.select([
        'config_idx', 'n_voters', 'temperature', 'electoral_system',
        'turnout_mean', 'gallagher_mean', 'enp_votes_mean'
    ]).head(10))
