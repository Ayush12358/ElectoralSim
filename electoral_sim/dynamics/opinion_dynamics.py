...
Implements:
- Network generation (Barabási-Albert, Watts-Strogatz) — in _networks.py
- Noisy voter model
...
from electoral_sim.dynamics._networks import (  # noqa: F401 — re-exported for backward compat
    NETWORKX_AVAILABLE,
    generate_network,
    network_diagnostics,
    network_stats,
