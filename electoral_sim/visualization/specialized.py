...
def plot_swing_analysis(
    ...
    fig.add_trace(go.Scatter(
        x=swings, y=seats, mode='lines+markers',
...
def plot_india_state_map(results_summary: Dict[str, Any]):
    ...
    STATE_COORDS = {
        ...
        "Tamil Nadu": [11.1271, 78.6569], "Madhya Pradesh": [22.9734, 78.6569],
        "Karnataka": [15.3173, 75.7139], "Gujarat": [22.2587, 71.1924],
        "Rajasthan": [27.0238, 74.2179], "Andhra Pradesh": [15.9129, 79.7400],
        "Odisha": [20.9517, 85.0985], "Kerala": [10.8505, 76.2711],
        "Telangana": [18.1124, 79.0193], "Jharkhand": [23.6102, 85.2799],
        "Assam": [26.2006, 92.9376], "Punjab": [31.1471, 75.3412],
        "Chhattisgarh": [21.2787, 81.8661], "Haryana": [29.0588, 76.0856],
    ...
    fig = px.scatter_geo(
        df.to_pandas(), lat="Lat", lon="Lon", color="Winner",
        hover_name="State", size="Seats",
        scope='asia', center={'lat': 22, 'lon': 80},
