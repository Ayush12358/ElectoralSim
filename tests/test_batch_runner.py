...
class TestBatchRunner:
    ...
    def test_basic_batch_run(self):
        ...
        # Check columns
        expected_cols = ['config_idx', 'run_idx', 'seed', 'n_voters', 'temperature', 
                        'turnout', 'gallagher', 'enp_votes', 'enp_seats']
    ...
    def test_summary_stats(self):
        ...
        expected_cols = ['config_idx', 'n_voters', 'turnout_mean', 'turnout_std',
                        'gallagher_mean', 'n_runs']
        for col in expected_cols:
