...
def adaptive_strategy_step(
    ...
    if strategy == "median_voter":
        ...
        voter_median_y = voters_df["ideology_y"].median() if "ideology_y" in voters_df.columns else 0.0
    ...
    return parties_df.with_columns([
        pl.Series(k, v) for k, v in update_dict.items()
    ])
